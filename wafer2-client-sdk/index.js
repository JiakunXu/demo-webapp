...
__DEFINE__(1618202570563, function(require, module, exports) {
...
}, function(modId) {var map = {"./lib/constants":1618202570564,"./lib/login":1618202570565,"./lib/session":1618202570566,"./lib/request":1618202570567,"./lib/tunnel":1618202570569}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1618202570564, function(require, module, exports) {
module.exports = {
    WX_HEADER_CODE: 'X-WX-Code',
    WX_HEADER_ENCRYPTED_DATA: 'X-WX-Encrypted-Data',
    WX_HEADER_IV: 'X-WX-IV',
    WX_HEADER_ID: 'X-WX-Id',
    WX_HEADER_SKEY: 'Authorization',
...
__DEFINE__(1618202570565, function(require, module, exports) {
/**
 * README!!!
 * 为了兼容微信修改的登录逻辑
 * 这里对登录的 SDK 进行重构
...
function loginWithCode (opts) {
    ...
    const _wx = wx.getSystemInfoSync().environment == "wxwork" ? wx.qy : wx
...
}, function(modId) { var map = {"./constants":1618202570564,"./session":1618202570566}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1618202570566, function(require, module, exports) {
var constants = require('./constants');
...
}, function(modId) { var map = {"./constants":1618202570564}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1618202570567, function(require, module, exports) {
var constants = require('./constants');
...
}, function(modId) { var map = {"./constants":1618202570564,"./utils":1618202570568,"./session":1618202570566,"./login":1618202570565}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1618202570568, function(require, module, exports) {
...
__DEFINE__(1618202570569, function(require, module, exports) {
...
}, function(modId) { var map = {"./request":1618202570567,"./wxTunnel":1618202570570}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1618202570570, function(require, module, exports) {
...
return __REQUIRE__(1618202570563);
})()
